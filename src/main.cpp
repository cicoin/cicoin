...
int64 nChainStartTime = 1461316912;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
        nSubsidy = 1000000000 * COIN;	// 1000 billion coins, that all pow coins
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Ari 22, 2016, Putin Signs Treaty To Add Crimea To Map.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x70018be683a42d55a0066617afe6e92cb7647c7800e9496922053e0c44be8120"));
...
unsigned char pchMessageStart[4] = { 0x67, 0x6f, 0x6f, 0x64 };
